...
export const Cart = () => {
  ...
  useEffect(() => {
    axios
      .get("https://makemytrip-api-data.onrender.com/flightcart")
      .then((res) => {
  ...
  const handledelete = (id) => {
    ...
    axios
      .delete(`hhttps://makemytrip-api-data.onrender.com/flightcart/${id}`)
      .then((res) => {
        console.log(res);
      })
      .catch((er) => {
    ...
    <div className="container">
            ...
            return (
              <div className="flight" key={el.id}>
                ...
                <div>
                  ...
                  <h3>Checkin - 15kg(1 piece only)</h3>

                  <h3>Cabin - 7kg(1 piece only)</h3>
      ...
      {payment > 0 && (
        <div className="paymentsum">
          ...
          <h3>
            Ticket price :- <span>+ {payment}</span>
          </h3>

          <h3>
            fee & Taxes :- <span>+ 1000</span>
          </h3>
