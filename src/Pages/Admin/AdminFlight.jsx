  ...
  return (
    ...
    <div>
        ...
        <FormControl >
            ...
            <Input id='input' type="text" name='departure' value={flight.departure} onChange={(e) => handleChange(e)}/>
            <FormLabel  id='label'>Arrival</FormLabel>
            <Input id='input' type="text" name='arrival' value={flight.arrival} onChange={(e) => handleChange(e)}/>
            <FormLabel  id='label'>Price</FormLabel>
            <Input id='input' type="number" name='price' value={flight.price} onChange={(e) => handleChange(e)}/>
            <FormLabel  id='label'>TotalTime</FormLabel>
            <Input id='input' type="text" name='totalTime' value={flight.totalTime} onChange={(e) => handleChange(e)}/>
            <Button id='btn'  variant='outline' type='submit'>Add Flight Info</Button>
            </Box>  
        </FormControl>
        </form>
        </Wrapper>
